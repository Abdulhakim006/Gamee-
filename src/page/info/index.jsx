...
import { Game, InfoPageStyle, Infos, Games } from './style';
                ...
                game.screenshots === undefined ?
                    ...
                    <InfoPageStyle backImg={game?.thumbnail}>
                        ...
                        <Game>
                            ...
                            <p> <i className='bi bi-person'></i> Requires 3rd-Party Account</p>
                        </Game>
                        <Infos>
                            <div>
                                <h2>{game?.title}</h2>
                                ...
                                <hr />
                                <q>All material on this page is copyrighted by ©KRAFTON, Inc. and their respective licensors. All other trademarks are the property of their respective owners.</q>
                                <h2>Games like {game?.title}</h2>
                                <hr />
                                <Games>
                                    {
                                        lastGame.map((item, index) => <div key={index}>
                                            <div className='card' onClick={() => navigate(`/info/${item?.id}`)}>
                                                <div><img src={item?.thumbnail} /></div>
                                                <h6> <div> {item?.title} </div> </h6>
                                            </div>
                                        </div>)
                                    }
                                </Games>
